...
1. Внедрить ежедневные проверки дискового пространства в cron (например, `df -h | mail -s "Disk Usage Alert" admin@example.com` при превышении 80%).
...
4. Документировать процедуру восстановления в виде playbook для быстрого реагирования на аналогичные инциденты.
